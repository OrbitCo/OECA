...
(function (factory) {
    ...
    if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
        ...
        define(["knockout", "knockout.validation.js", "exports"], factory);
    } else {
    ...
    exports = function (ruleSet, options) {
        ...
        function traverseGraph(obj, options, parentNode) {
            var objValues = [],
            ...
            utils.objectForEach(objValues, function (k, v) {
                var node = (parentNode ? parentNode + "." : "") + k;

                var fieldRules = getFieldRuleSet(node);

                if (fieldRules && ko.isObservable(v)) {
                    v.extend(fieldRules);
                }
                if (options.deep && v !== undefined && !ko.isObservable(v)) {
                    traverseGraph(v, options, node);
                }
            });
        }
